          ...
          <div className="measure">
            ...
            <div className="">
              <input
                ...
                className="sega fw3 ph3 pv2 input-reset ba b--black bg-transparent grow pointer f6 dib"
                type="submit"
                value="Register"
              />
            </div>
...
// input field border to be slightly thicker for name, email and password